...
* `entityType`: [su.entitytypes.md](../../su-api-enums/su.entitytypes.md "mention") , -1 wenn keine Gebäude-Typen gefiltert werden sollen
...
<strong>-- Alle Entitäten bei 115/70 im Radius von 10
    	...
    	dbg.stm(getn(entities)) -- Anzahl der Entitäten
